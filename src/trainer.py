...
class stats():
    ...
    def report(self,n_steps,trn_val_tst,cuda):
        ...
        logging.info("{} nsteps: {} Loss: {:.6f} (mlm:{:.6f}, ali:{:.6f}) steps/sec: {:.1f}".format(trn_val_tst, n_steps, loss_avg, loss_mlm_avg, loss_ali_avg, self.n_steps/(time.time()-self.start)))
